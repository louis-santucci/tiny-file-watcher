...
func TestMachineDB_CreateMachine_OK(t *testing.T) {
	...
	m, err := db.CreateMachine("my-machine", "tok-abc", "192.168.1.1", 22, "ssh-user", "ssh-key", "/tmp/host.pub")
...
func TestMachineDB_CreateMachine_ErrorDuplicateToken(t *testing.T) {
	...
	_, err := db.CreateMachine("my-machine", "tok-abc", "192.168.1.1", 22, "ssh-user", "ssh-key", "/tmp/host.pub")
	require.NoError(t, err)
	_, err = db.CreateMachine("my-machine_2", "tok-abc", "192.168.1.2", 22, "ssh-user", "ssh-key", "/tmp/host.pub")
...
func TestMachineDB_GetMachineByName_OK(t *testing.T) {
	...
	_, err := db.CreateMachine("lookup-machine", "tok-lookup", "172.16.0.1", 22, "ssh-user", "ssh-key", "/tmp/host.pub")
	require.NoError(t, err)
...
func TestMachineDB_GetMachineByToken_OK(t *testing.T) {
	...
	_, err := db.CreateMachine("token-machine", "tok-xyz", "192.168.0.10", 22, "ssh-user", "ssh-key", "/tmp/host.pub")
	require.NoError(t, err)
...
func TestMachineDB_DeleteMachine_OK(t *testing.T) {
	...
	_, err := db.CreateMachine("delete-me", "tok-del", "1.1.1.1", 22, "ssh-user", "ssh-key", "/tmp/host.pub")
	require.NoError(t, err)
